// перенести все свойства, которые нужны для рендера темплейта в функцию рендера темплейта
// вынести логику рендера темплейта колонки в отдельный класс
// все состояние класса вынести наверх
